...
BEGIN
	EXECUTE('CREATE PROCEDURE [dbo].[spWorkflowProcessResetRunningStatus]
	AS
	BEGIN
...
BEGIN
	EXECUTE('CREATE PROCEDURE [dbo].[DropWorkflowProcess] 
		@id uniqueidentifier
	AS
	BEGIN
		BEGIN TRAN
...
BEGIN
	...
	EXECUTE('CREATE PROCEDURE [dbo].[DropWorkflowProcesses] 
...
BEGIN
	EXECUTE('CREATE PROCEDURE [dbo].[DropWorkflowInbox] 
